...
@Composable
fun LoginPage(modifier: Modifier =Modifier,navController: NavController,viewModel: AuthViewModel){
    ...
    Column(
        ...
        OutlinedButton(onClick = {
            scope.launch{
                signInWithGoogle(context,navController,viewModel)
            }
        }) {
...
private  suspend fun signInWithGoogle(context: Context, navController: NavController,viewModel: AuthViewModel){
...
private suspend fun getIdToken(context:Context):String {
    ...
    val googleIdOption = GetGoogleIdOption
        .Builder()
        .setServerClientId("124699743753-buml2ilvr3toblvkflvg699e2l9ebe68.apps.googleusercontent.com")
